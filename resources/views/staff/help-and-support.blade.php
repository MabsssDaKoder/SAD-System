...
<style>
    ...
    .page-header { padding: 2rem 2rem 0.5rem 2rem; flex-shrink: 0; }
    .page-title { font-size: 1.9rem; font-weight: 700; color: #1a2535; margin: 0 0 0.25rem 0; }
    .page-subtitle { font-size: 0.9rem; color: #7a8999; margin: 0; }
    .content-wrapper {
        flex: 1;
    ...
    .card-header-title { font-size: 1.05rem; font-weight: 600; color: #1a2535; margin: 0; }
    ...
    .contact-card:hover { border-color: #1a2535; box-shadow: 0 4px 16px rgba(26,37,53,0.1); transform: translateY(-2px); }
    .contact-card-icon {
        width: 52px; height: 52px; border-radius: 12px;
        display: flex; align-items: center; justify-content: center;
        font-size: 1.5rem; margin: 0 auto 1rem auto;
    }
    .contact-card-icon.amber { background: #fef3c7; }
    .contact-card h4 { font-size: 0.95rem; font-weight: 700; color: #1a2535; margin: 0 0 0.35rem 0; }
    .contact-card p { font-size: 0.82rem; color: #7a8999; margin: 0 0 0.75rem 0; line-height: 1.4; }
    .contact-card .contact-link { font-size: 0.85rem; font-weight: 600; color: #1a2535; }

    .faq-search { display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.5rem; }
    .faq-search-wrap { position: relative; flex: 1; }
    ...
    .faq-search input {
        ...
        border: 1px solid #d0d9e3; border-radius: 7px;
        font-size: 0.92rem; color: #1a2535;
        transition: border-color 0.2s, box-shadow 0.2s;
        box-sizing: border-box;
    }
    .faq-search input:focus { outline: none; border-color: #1a2535; box-shadow: 0 0 0 3px rgba(26,37,53,0.08); }
    ...
    .faq-question {
        ...
        font-size: 0.92rem; font-weight: 600; color: #1a2535;
        cursor: pointer; text-align: left; transition: background 0.2s;
    }
    .faq-question:hover { background: #f8fafc; }
    .faq-question .faq-icon { font-size: 1rem; transition: transform 0.25s; flex-shrink: 0; margin-left: 1rem; color: #7a8999; }
    ...
    .form-group select,
    .form-group textarea {
        padding: 0.7rem 1rem; border: 1px solid #d0d9e3;
        border-radius: 7px; font-size: 0.92rem; color: #1a2535;
        background: white; transition: border-color 0.2s, box-shadow 0.2s;
        width: 100%; box-sizing: border-box;
    }
    .form-group input:focus,
    .form-group select:focus,
    .form-group textarea:focus { outline: none; border-color: #1a2535; box-shadow: 0 0 0 3px rgba(26,37,53,0.08); }
    .form-group textarea { resize: vertical; min-height: 110px; }
    .form-grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; }
    .action-row { display: flex; gap: 1rem; justify-content: flex-end; margin-top: 1.5rem; }
    .btn { padding: 0.7rem 2rem; border-radius: 7px; font-weight: 600; font-size: 0.92rem; cursor: pointer; border: none; transition: all 0.2s; }
